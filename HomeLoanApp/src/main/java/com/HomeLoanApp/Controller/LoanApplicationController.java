...
public class LoanApplicationController {
	...
	public LoanApplication addLoanApplication(@RequestBody LoanApplication loanapp,@PathVariable("adminId") int adminId,@PathVariable("customerId") int customerId) {
	...
	public LoanApplication addLoanApplicationCustomer(@RequestBody LoanApplication loanApp,@PathVariable("userId") int userId) {
		User u=usi.findUserWithId(userId);
